...
u8 GT9147_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin =GPIO_Pin_1|GPIO_Pin_13;// PC1和PC13端口配置
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;	//推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(GPIOC, &GPIO_InitStructure);
	GPIO_SetBits(GPIOC,GPIO_Pin_1);						//输出1
	...
	GPIO_Init(GPIOC, &GPIO_InitStructure);			//PC1下拉输入
	GPIO_ResetBits(GPIOC,GPIO_Pin_1);				//下拉	
